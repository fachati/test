                ...
                sPool.submit(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            blink(new XBee64BitAddress(new byte[]{0x00,0x13, (byte) 0xA2,0x00,0x40, (byte) 0xDC, (byte) 0xA8, (byte) 0xBE}), (byte) 0x02);
                            blink(new XBee64BitAddress(new byte[]{0x00,0x13, (byte) 0xA2,0x00,0x40, (byte) 0x98, (byte) 0xB8, (byte) 0xA2}), (byte) 0x02);
            ...
            Intent  intentSendInformation = new Intent(ACTION_SEND_STATUS);
                ...
                if(data[5]==0xe0){ //e0
                    ...
                    intentSendInformation.putExtra("plug",data[7]);
                            /*String session_plugE3="";
                            if(tabTram[7].compareTo("1")==0)
                                session_plugE3="EV";
                            else if(tabTram[7].compareTo("2")==0)
                                session_plugE3="AUX";*/
